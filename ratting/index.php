...
if($rev==0){
$divClass=$html->find('.c-bets__inner',0);
    $val1=floatval(strip_tags($divClass));
$divClass=$html->find('.c-bets__inner',2);
    $val2=floatval(strip_tags($divClass));
}else{
  $divClass=$html->find('.c-bets__inner',2);
    $val1=floatval(strip_tags($divClass));
$divClass=$html->find('.c-bets__inner',0);
...
$conn = $pdo->open();
$stmt = $conn->prepare("UPDATE cricket_match SET cricket_match_team1_ratio=:val1, cricket_match_team2_ratio=:val2 WHERE cricket_match_cricket_id=:id");
$stmt->execute(['val1'=>$val1, 'val2'=>$val2, 'id'=>$id]);
echo $val1.' - '.$val2;
    $pdo->close();
