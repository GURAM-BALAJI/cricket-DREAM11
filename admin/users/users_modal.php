    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                    <label for="referal" class="col-sm-3 control-label">Referal Code</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="referal" name="referal" placeholder="Optional">
                    </div>
                </div>
...
<div class="modal fade" id="edit_amount">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="users_amount.php">
                    <input type="hidden" class="userid" name="id">
                    <div class="text-center">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="amount" class=" bold col-sm-5 control-label">Present Amount : </label>
                            <div class="col-sm-4">
                                <h5 class="amount"></h5>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="add_amount" class=" bold col-sm-5 control-label">Add Amount : </label>
                            <div class="col-sm-4">
                                <input  type="number" step="any" class="form-control" name="add_amount" required>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                <button type="submit" class="btn btn-success btn-flat" name="add"><i class="fa fa-check"></i> ADD AMOUNT</button>
                </form>
            </div>
        </div>
    </div>
