    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Add New Cricket Match</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="match_add.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="cricket" name="cricket" required>
                          ...
                          <?php 
                $stmt1 = $conn->prepare("SELECT cricket_id,cricket_name FROM cricket WHERE cricket_delete='0' AND cricket_active='1' AND cricket_id NOT in (select cricket_match_cricket_id from cricket_match where cricket_match_delete='0')");
                      $stmt1->execute();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Edit Cricket Match</b></h4>
            </div>
            
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="match_edit.php">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="match_delete.php">
                <input type="hidden" class="delete_cricket_id" name="id">
                <div class="text-center">
                    <p>DELETE CRICKET MATCH</p>
...
<!-- match won -->
<div class="modal fade" id="match_won">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Match Won By</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="match_won_by.php">
                <input type="hidden" class="win_cricket_id" name="cricket_id">
                <div class="text-center">
                    <p>CRICKET MATCH WON BY</p>
...
<div class="modal fade" id="suspend">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="match_suspend.php">
                <input type="hidden" class="cricket_suspend_id" name="id">
                <div class="text-center">
                    <p>SUSPEND CRICKET MATCH</p>
