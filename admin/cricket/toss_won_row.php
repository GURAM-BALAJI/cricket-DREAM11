<?php 
	...
	if(isset($_POST['id'])){
        ...
        $options="  <div class='form-group'>
                    <label for='won_team' class='col-sm-3 control-label'>Toss Won By</label>
                    <div class='col-sm-9'>
                      <select class='form-control' id='won_team' name='won_team' required>
                          <option value=''>Select Won Team</option>
<option value='$cricket_toss_team1_id'>$team1_name</option>
<option value='$cricket_toss_team2_id'>$team2_name</option>
                        </select>
                    </div>
                </div>";
            $row = array(
'cricket_id'=>$cricket_toss_cricket_id,
