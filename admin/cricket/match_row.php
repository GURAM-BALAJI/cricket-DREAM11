<?php 
	...
	if(isset($_POST['id'])){
		...
		foreach($stmt as $row1){
            ...
            $row = array(
'cricket_match_cricket_id'=>$id,
'cricket_match_team1_id'=>$cricket_match_team1_id,
'cricket_match_team1_ratio'=>$cricket_match_team1_ratio,
'cricket_match_team2_id'=>$cricket_match_team2_id,
'cricket_match_team2_ratio'=>$cricket_match_team2_ratio,
